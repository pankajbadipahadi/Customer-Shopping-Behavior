...
SELECT subscription_status, COUNT(customer_id) as total_cutomers,
...
--Q7. Segment customers into New, Retturning, and Loyal Based on their total number of previous purchases, and show the count of each segment.
...
--Q8. What are the most top 3 purchased products within each category?
with item_counts as(
select category,
item_purchased,
